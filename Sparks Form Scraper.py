...
driver.find_element(By.ID, "ce_raa5lp_an_entry").send_keys("Asia / Bangladesh / Dhaka")
driver.find_element(By.ID, "ce_raa5lp_aw_select").send_keys("VOC Omicron GRA (B.1.1.529+BA.*) first detected in Botswana/Hong Kong/South Africa")
driver.find_element(By.ID, "ce_raa5lp_ao_entry").send_keys("Human")
